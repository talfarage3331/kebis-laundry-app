    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <form onSubmit={submit} className="mx-auto max-w-md w-full px-6 mt-8 space-y-4 flex-1">
        ...
        <button
          ...
          className="w-full mt-2 flex items-center justify-center gap-2 rounded-3xl bg-white text-gray-800 py-4 text-lg font-semibold shadow-md hover:bg-gray-100 transition"
        >
